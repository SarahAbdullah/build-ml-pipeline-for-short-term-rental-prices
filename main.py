...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "train_random_forest" in active_steps:
            ...
            # Convert to a plain Python dictionary so it's JSON serializable
            random_forest_config = OmegaConf.to_container(config["modeling"]["random_forest"], resolve=True)

            with open(rf_config, "w+") as fp:
                json.dump(random_forest_config, fp)  # DO NOT TOUCH
